...
/**
 * Created by enigma-pc on 4/16/2017.
 */
...
*/
       ...
       // setContentView(activityLayout);
        ...
        tvComposedText.setText(strBody);
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            ComposeMailUsingGmail.REQUEST_AUTHORIZATION);
                } else {
                    Toast.makeText(getApplicationContext(),"The following error occurred:",Toast.LENGTH_SHORT).show();
